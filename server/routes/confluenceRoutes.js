...
//   try {
//     const apiUrl = `${config.CONFLUENCE_URL.endsWith('/') ? config.CONFLUENCE_URL.slice(0, -1) : config.CONFLUENCE_URL}/rest/api/content`;
...
//     const pageUrl = `${config.CONFLUENCE_URL.endsWith('/') ? config.CONFLUENCE_URL.slice(0, -1) : config.CONFLUENCE_URL}/spaces/${config.SPACE_KEY}/pages/${pageId}`;
